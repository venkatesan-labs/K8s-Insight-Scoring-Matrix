            ...
            steps {
                ...
                script {
                    sh """
                        ...
                        sh (script: "kubectl patch domain dianna-beholdable-larissa-ngrok-free-dev -n k8s-insight-${params.ENV} --type merge -p '{"metadata":{"finalizers":null}}'", returnStatus: true)
